    ...
    <div class="message_from">
        <div class="message">
            ...
            <div class="message_input">
                <div class="message_input_div" @keyup="keyUp" @keydown="keyDown">
                    <el-input
                    type="textarea"
                    maxRows = '2'
...
export default {
    ...
    mounted() {
        ...
        const socket = io('http://new.frome.co.kr:2101', {transports:['websocket'],  secure: true, reconnect: true, rejectUnauthorized : false  }); 

        //const socket = io('http://192.168.219.104:2900');
